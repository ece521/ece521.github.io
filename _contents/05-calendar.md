...
| Lecture: Thursday, Jan 19 |   [Stochastic gradient descent, Léon Bottou](http://cilvr.cs.nyu.edu/diglib/lsml/bottou-sgd-tricks-2012.pdf) <br/> [(free)The momentum method: *Coursera video: Neural Networks for Machine Learning Lecture 6.3*](https://www.youtube.com/watch?v=LdkkZglLZ0Q) <br/> (free) Maximum likelihood for a Gaussian: *MacKay 2003, Chap. 22.1*  <br/> (free) Maximum likelihhod estimation of a classifier: *Hastie et al 2013, Chap. 2.6.3*  <br/> (free) Regularization: *Goodfellow et al 2016, Chap. 7.1* <br/> (free) Regularization through data augmentation: *Goodfellow et al 2016, Chap. 7.4*      | Maximum likelihood estimation (MLE)]<br/> Optimization and regularization <br/>[pdf slides](http://www.mebden.com/ECE521/Lec4.pdf)
