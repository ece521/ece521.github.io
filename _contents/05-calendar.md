...
| **Week 2** |            | 
| Lecture: Monday, Jan 16 | The curse of dimensionality: *Bishop 2006, Chap. 1.4* <br/> K-NN: *Bishop 2006, Chap. 2.5.2* <br/> (free) K-NN and linear regression: *Hastie et al 2013, Chap. 2.3*  <br/> (free) Convex function and Jensen inequality: *MacKay 2003, Chap. 2.7*  <br/> (free) Gradient descent: *Goodfellow et al 2016, Chap. 4.3*      | Example: K Nearest Neighbours <br/> Optimization  
| Lecture: Thursday, Jan 19 |   [Stochastic gradient descent, Léon Bottou](http://cilvr.cs.nyu.edu/diglib/lsml/bottou-sgd-tricks-2012.pdf) <br/> (free)The momentum method: *Coursera video: Neural Networks for Machine Learning Lecture 6.3* <br/> (free) Maximum likelihood for a Gaussian: *MacKay 2003, Chap. 22.1*  <br/> (free) Maximum likelihhod estimation of a classifier: *Hastie et al 2013, Chap. 2.6.3*  <br/> (free) Regularization: *Goodfellow et al 2016, Chap. 7.1* <br/> (free) Regularization through data augmentation: *Goodfellow et al 2016, Chap. 7.4*      | Maximum likelihood estimation (MLE) <br/> Optimization and regularization 
